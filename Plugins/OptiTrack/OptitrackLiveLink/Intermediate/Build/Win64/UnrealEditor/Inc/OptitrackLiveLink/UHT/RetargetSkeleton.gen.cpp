...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_OptitrackLiveLink_OptiTrackBoneID_Statics::Enumerators[] = {
		...
		{ "OptiTrackBoneID::Origin", (int64)OptiTrackBoneID::Origin },
		{ "OptiTrackBoneID::NumBones", (int64)OptiTrackBoneID::NumBones },
		{ "OptiTrackBoneID::FirstBone", (int64)OptiTrackBoneID::FirstBone },
		{ "OptiTrackBoneID::LastBone", (int64)OptiTrackBoneID::LastBone },
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_OptitrackLiveLink_OptiTrackBoneID_Statics::Enum_MetaDataParams[] = {
		{ "FirstBone.Name", "OptiTrackBoneID::FirstBone" },
		{ "Head.Name", "OptiTrackBoneID::Head" },
		{ "Hips.Name", "OptiTrackBoneID::Hips" },
		{ "LastBone.Name", "OptiTrackBoneID::LastBone" },
		...
		{ "Origin.Name", "OptiTrackBoneID::Origin" },
	...
	struct Z_CompiledInDeferFile_FID_Users_r1ver_OneDrive_Desktop_OptitrackLiveLink_HostProject_Plugins_OptitrackLiveLink_Source_OptitrackLiveLink_Public_RetargetSkeleton_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_r1ver_OneDrive_Desktop_OptitrackLiveLink_HostProject_Plugins_OptitrackLiveLink_Source_OptitrackLiveLink_Public_RetargetSkeleton_h_Statics::EnumInfo[] = {
		{ OptiTrackBoneID_StaticEnum, TEXT("OptiTrackBoneID"), &Z_Registration_Info_UEnum_OptiTrackBoneID, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 309149984U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_r1ver_OneDrive_Desktop_OptitrackLiveLink_HostProject_Plugins_OptitrackLiveLink_Source_OptitrackLiveLink_Public_RetargetSkeleton_h_513586821(TEXT("/Script/OptitrackLiveLink"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_r1ver_OneDrive_Desktop_OptitrackLiveLink_HostProject_Plugins_OptitrackLiveLink_Source_OptitrackLiveLink_Public_RetargetSkeleton_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_r1ver_OneDrive_Desktop_OptitrackLiveLink_HostProject_Plugins_OptitrackLiveLink_Source_OptitrackLiveLink_Public_RetargetSkeleton_h_Statics::EnumInfo));
